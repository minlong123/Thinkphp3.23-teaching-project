		 ...
		 <div class="bs-example" data-example-id="table-within-panel">
		    <div class="panel panel-default">
		      ...
		      <div class="panel-body nav-lists">
		        <p>默认显示最近所有文章</p>
		        <a href="" class="btn btn-primary">专家顾问文章管理</a>
		        <a href="" class="btn btn-primary">新闻动态文章管理</a>
		        <a href="" class="btn btn-primary">客户案例文章管理</a>
			      ...
			      <table class="table table-bordered">
			        ...
			        <tbody>
			          ...
			          <tr>
			            ...
			            <td><a href="/index.php/Admin/Article/edit" class="btn btn-warning">修改</a>&nbsp;<a href="#" type="button" class="btn btn-danger" data-toggle="modal" data-target="#gridSystemModal">删除</a></td>
			          </tr>
