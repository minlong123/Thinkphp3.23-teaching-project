...
<section class="container-fluid mana-edit">
	<div class="row">
		...
		<div class="col-lg-9">
          ...
          <form class="form-horizontal" method="post" action="/index.php/Admin/Cateart/add" enctype="multipart/form-data">
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-1 control-label">长标题</label>
              <div class="col-sm-11">
                <input type="text" name="lartitle" class="form-control" id="inputEmail3" placeholder="输入您的长标题">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
                <input type="text" name="shotitle" class="form-control" id="inputEmail3" placeholder="输入您的短标题">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-11">
                <select class="form-control" name="cateid">
                  ...
                  <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
                <input type="text" name="descs" class="form-control" id="inputEmail3" placeholder="输入您对文章的描述">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
                <input type="text" name="browse" class="form-control" id="inputEmail3" placeholder="自定义浏览人数">
              </div>
            </div>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-11">
              	<textarea id="containers" name="con" style="height:500px;"></textarea>
              </div>
            </div>
