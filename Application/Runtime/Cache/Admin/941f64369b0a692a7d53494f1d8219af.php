      ...
      <ul class="nav navbar-nav navbar-right">       
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/index.php/Admin/Admins/editperson/id/<?php echo $_SESSION['id']?>">修改账户密码</a></li>
          </ul>
        </li>
...
<section class="container-fluid mana-edit">
	<div class="row">
				<div class="col-lg-3">
			<ul class="list-group">
			  <li class="list-group-item"><a href="/index.php/Admin/Admins/index">管理员管理</a></li>
		...
		<div class="col-lg-9">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				...
				<form class="form-inline" method="post" action="/index.php/Admin/Admins/editperson">
