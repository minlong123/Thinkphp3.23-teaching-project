		...
		<div class="exar_con">
			...
			<div class="exar_con_right">
				...
				<div class="exar_right_middle">
					<ul>
						<?php if(is_array($exportlist)): $i = 0; $__LIST__ = $exportlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/compnews/<?php echo ($vo["cateid"]); ?>/<?php echo ($vo["id"]); ?>"><?php echo (date("Y-m",$vo["times"])); ?> · <?php echo (msubstr($vo["shotitle"],0,11,'utf8')); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
