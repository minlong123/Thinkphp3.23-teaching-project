...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost:82/Application/Home/public/css/news.css">
</head>
<body>
	<!-- 导航内容开始 -->
	<div id="header">
	...
	<div id="case4">
		...
		<div class="case4_by_middle">NEWS INFORMATION</div>
	</div>
	<!-- 第一部分 -->
	...
	<div id="new1_one">
		<div class="new1_one1">
			<div class="new1_one_con">


				<div class="new1_one_con1">
					<a href="/newss/31"  class="new1_one_con2">
						<span>公司动态</span>
				...
				<div class="new1_one_con1">
					<a href="/news/29" class="new1_one_con2">
						<span>行业动态</span>
						<span class="new1_select"><img src="http://localhost:82/Application/Home/public/images/case_img.png"></span>
					</a>
				</div>
	...
	<!-- 第三部分 -->
	<div id="new1_two">
		<div class="new1_two_top">

			<?php if(is_array($artlist)): $i = 0; $__LIST__ = $artlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="new1_top_con">
				<div class="new1_two_left"><a href="/compnews/<?php echo ($vo["cateid"]); ?>/<?php echo ($vo["id"]); ?>"><img src="/<?php echo ($vo["pic"]); ?>" width="290" height="120"></a></div>

				<div class="new1_two_right">
					<div class="new1_two_right1">
						<a href="/compnews/<?php echo ($vo["cateid"]); ?>/<?php echo ($vo["id"]); ?>"><?php echo ($vo["shotitle"]); ?></a>
					</div>
					<div class="new1_two_right2"><?php echo ($vo["descs"]); ?></div>
					<div class="new1_two_right3"><?php echo (date("Y-m-d",$vo["times"])); ?></div>
				</div>
