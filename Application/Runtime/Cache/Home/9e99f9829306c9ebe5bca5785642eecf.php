		...
		<div class="exar_con">
			...
			<div class="exar_con_right">
				...
				<div class="exar_right_top">
					<div class="exar_right_top1"><?php echo ($exportlist[0]['catename']); ?></div>
					<div class="exar_right_top2"><a href="<?php echo ($exportlist[0]['url']); ?>/<?php echo ($exportlist[0]['cateid']); ?>">MORE</a></div>
				</div>


				<div class="exar_right_middle">
					<ul>
						<?php if(is_array($exportlist)): $i = 0; $__LIST__ = $exportlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/casepnews/<?php echo ($vo["cateid"]); ?>/<?php echo ($vo["id"]); ?>"><?php echo (date("Y-m",$vo["times"])); ?> · <?php echo (msubstr($vo["shotitle"],0,11,'utf8')); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
