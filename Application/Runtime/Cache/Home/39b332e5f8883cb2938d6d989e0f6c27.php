		...
		<div class="navigator">
			...
			<div class="navigator_nav">
				<ul class="navigator_nav_ul">
					...
					<li class="select_black"><a href="/index.php/Home/home">首页</a></li>

					<li>
						<a href="javascript:void(0)">企业营销</a>
						<ol class="hover_li">
							<li><a href="/index.php/Home/website">网站开发</a></li>
							<li><a href="/index.php/Home/small">小程序建设</a></li>
							<li><a href="/index.php/Home/marketing">电商运营</a></li>
						</ol>
					</li>
					...
					<li>
						<a href="#">策划服务</a>
						<ol class="hover_li">
							<li><a href="/index.php/Home/brand">品牌营销策划</a></li>
							<li><a href="/index.php/Home/whole">营销全案策划</a></li>
							<li><a href="/index.php/Home/extension">营销推广策划</a></li>
							<li><a href="/index.php/Home/active">会务活动策划</a></li>
						</ol>
					</li>
					<li><a href="/index.php/Home/export">专家顾问</a></li>
					<li>
						<a href="#">新闻动态</a>
						<ol class="hover_li">
							<li><a href="/index.php/Home/about">行业动态</a></li>
							<li><a href="/index.php/Home/about">公司动态</a></li>
						</ol>
					</li>
					<li>
						<a href="#">客户案例</a>
						<ol class="hover_li">
							<li><a href="/index.php/Home/about">营销策划案例</a></li>
							<li><a href="/index.php/Home/about">网站建设案例</a></li>
							<li><a href="/index.php/Home/about">小程序开发案例</a></li>
							<li><a href="/index.php/Home/about">电商运营案例</a></li>
						</ol>
					</li>
					<li class="last_child"><a href="/index.php/Home/about">关于世阳</a></li>
		...
		<div class="plan_content">
			...
			<div class="plan_content_bottom">
				...
				<div class="plan_bottom_one spin">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/plan.png"></a></div>
					<div class="plan_bottom_one1"><a href="">品牌营销策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/plan1.jpg"></div>
					<div class="plan_bottom_one1"><a href="">营销全案策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/plan2.png"></a></div>
					<div class="plan_bottom_one1"><a href="">营销推广策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/plan3.png"></a></div>
		...
		<div class="marketing_content">
			...
			<div  class="marketing_content_bottom">
				...
				<div class="marketing_content_children1 enlarge marketing_select">
					<span><a href=""><img src="http://localhost:82/Application/Home/public/images/marketing.jpg" width="308" height="190"></a></span>
					<p><a href="">网站建设</a></p>
				</div>

				<div class="marketing_content_children1 marketing_content_children2 enlarge">
					<span><a href=""><img src="http://localhost:82/Application/Home/public/images/marketing1.jpg" width="308" height="190"></a></span>
					<p><a href="">小程序开发</a></p>
				</div>

				<div class="marketing_content_children1 marketing_content_children2 enlarge">
					<span><a href=""><img src="http://localhost:82/Application/Home/public/images/marketing2.jpg" width="308" height="190"></a></span>
					<p><a href="">电商运营</a></p>
				</div>
		...
		<div class="case_content">
			...
			<div class="case_content_bottom">
				...
				<div class="case_bottom_one topMove case_select">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/case1.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/case2.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/case3.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/case4.jpg" height="135" width="230"></a></div>
		...
		<div class="export_content">
			...
			<div class="export_content_bottom">
				...
				<div class="bottomMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/pro-1.png"></a></div>
					<div class="export_content_name">王克</div>
					<div class="export_content_newname">中国企业发展规划院院长</div>
				</div>

				<div class="bottomMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/pro-2.png"></a></div>
					<div class="export_content_name">何阳</div>
					<div class="export_content_newname">中国现代咨询策划业的创始人</div>
				</div>

				<div class="bottomMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/pro-3.png"></a></div>
					<div class="export_content_name">罗立</div>
					<div class="export_content_newname">中国策划研究院终身名誉院长</div>
				</div>

				<div class="bottomMove">
					<div><a href=""><img src="http://localhost:82/Application/Home/public/images/pro-4.png"></a></div>
		...
		<div class="news_content">
			...
			<div class="news_content_bottom">
				...
				<div class="news_bottom_left rightD">
					<div><img src="http://localhost:82/Application/Home/public/images/news.jpg" width="490" height="160"></div>
