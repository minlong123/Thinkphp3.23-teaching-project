...
<body>
	...
	<div id="header">
		<div class="navigator">
			...
			<div class="navigator_logo"><img src="images/cehuaren.jpg" height="80"></div>
	...
	<div id="play">
		<div class="play_img">
			<ul class="play_ul">
				<li class="play_select" style="background:url('images/ad-0.jpg') center"></li>
				<li style="background:url('images/ad-1.jpg') center"></li>
				<li style="background:url('images/ad-2.jpg') center"></li>
			</ul>
		</div>
		...
		<div class="plan_content">
			...
			<div class="plan_content_bottom">
				...
				<div class="plan_bottom_one spin">
					<div><a href=""><img src="images/plan.png"></a></div>
					<div class="plan_bottom_one1"><a href="">品牌营销策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="images/plan1.jpg"></div>
					<div class="plan_bottom_one1"><a href="">营销全案策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="images/plan2.png"></a></div>
					<div class="plan_bottom_one1"><a href="">营销推广策划</a></div>
				</div>


				<div class="plan_bottom_one spin">
					<div><a href=""><img src="images/plan3.png"></a></div>
		...
		<div class="marketing_content">
			...
			<div  class="marketing_content_bottom">
				...
				<div class="marketing_content_children1 enlarge marketing_select">
					<span><a href=""><img src="images/marketing.jpg" width="308" height="190"></a></span>
					<p><a href="">网站建设</a></p>
				</div>

				<div class="marketing_content_children1 marketing_content_children2 enlarge">
					<span><a href=""><img src="images/marketing1.jpg" width="308" height="190"></a></span>
					<p><a href="">小程序开发</a></p>
				</div>

				<div class="marketing_content_children1 marketing_content_children2 enlarge">
					<span><a href=""><img src="images/marketing2.jpg" width="308" height="190"></a></span>
					<p><a href="">电商运营</a></p>
				</div>
		...
		<div class="case_content">
			...
			<div class="case_content_bottom">
				...
				<div class="case_bottom_one topMove case_select">
					<div><a href=""><img src="images/case1.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="images/case2.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="images/case3.jpg" height="135" width="230"></a></div>
				...
				<div class="case_bottom_one case_bottom_two topMove">
					<div><a href=""><img src="images/case4.jpg" height="135" width="230"></a></div>
	...
	<div id="company">
		<div class="company_content">
			...
			<div class="company_content_left">
				<img src="images/synopsis.jpg" width="403" height="243">
			</div>
		...
		<div class="model_content">
			...
			<div class="model_content_bottom">
				<div class="model_bottom_one">
					...
					<div class="model_bottom_one1 shortLeft rightMove" data-img="images/model1.jpg" data-imgs="images/model-1.jpg">
						<div class="model_bottom_details1"><span><img src="images/model1.jpg" /></span></div>
					...
					<div class="model_bottom_one1 shortBottom" data-img="images/model2.jpg" data-imgs="images/model-2.jpg">
						
						<div class="model_bottom_details1"><span><img src="images/model2.jpg" /></span></div>
					...
					<div class="model_bottom_one1 leftMove" data-img="images/model3.jpg" data-imgs="images/model-3.jpg">
						<div class="model_bottom_details1"><span><img src="images/model3.jpg" /></span></div>
						<div class="model_bottom_details2">
							<div class="model_details2_content">
				...
				<div class="model_bottom_one">
					...
					<div class="model_bottom_one1 rightMove" data-img="images/model4.jpg" data-imgs="images/model-4.jpg">
						<div class="model_bottom_details1"><span><img src="images/model4.jpg" /></span></div>
						<div class="model_bottom_details2">
							<div class="model_details2_content">
					...
					<div class="model_bottom_one1 shortTop" data-img="images/model5.jpg" data-imgs="images/model-5.jpg">
						<div class="model_bottom_details1"><span><img src="images/model5.jpg" /></span></div>
						<div class="model_bottom_details2">
							<div class="model_details2_content">
					...
					<div class="model_bottom_one1 leftMove" data-img="images/model6.jpg" data-imgs="images/model-6.jpg">
						<div class="model_bottom_details1"><span><img src="images/model6.jpg" /></span></div>
						<div class="model_bottom_details2">
							<div class="model_details2_content">
		...
		<div class="news_content">
			...
			<div class="news_content_bottom">
				...
				<div class="news_bottom_left rightD">
					<div><img src="images/news.jpg" width="490" height="160"></div>
	...
	<div class="h-dialog">
		...
		<div class="h-dialog-t">
			<div>项目经理 :<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=249650419&site=qq&menu=yes"><img border="0" src="images/qq.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></div>
			...
			<div class="h-dialog-t2"><img src="images/weixinn.jpg"></div>
		</div>
