...
<body>
	...
	<div id="header">
		<div class="navigator">
			...
			<!-- 		<li class="select_black"><a href="/index.php/Home/index">首页</a></li>
					</volist> -->


					<?php if(is_array($navlist)): $i = 0; $__LIST__ = $navlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<a <?php if(isset($vo['items'])): ?>href="javascript:void(0)"<?php else: ?>href="/index.php/Home<?php echo ($vo["url"]); ?>/index/id/<?php echo ($vo["id"]); ?>"<?php endif; ?>><?php echo ($vo["catename"]); ?></a>
						<?php if(isset($vo['items'])): ?><ol class="hover_li">
							<?php if(is_array($vo['items'])): $i = 0; $__LIST__ = $vo['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><li><a href="/index.php/Home<?php echo ($voo["url"]); ?>/index/id/<?php echo ($voo["id"]); ?>"><?php echo ($voo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ol><?php endif; ?>
	...
	<div id="export_by">
		<div class="export_by_con">
			...
			<div class="export_by_bottom">
				...
				<div class="export_by_bottom1">

					<div class="export_by_bottom2"><a href="#"><img src="http://localhost:82/Application/Home/public/images/download.jpg" width="162" height="216"></a></div>


					<div class="export_by_bottom3">
						<div class="export_by_bottom4">龙夫</div>
						<div class="export_by_bottom5">亚洲十大品牌创新人物</div>
					</div>
				</div>
