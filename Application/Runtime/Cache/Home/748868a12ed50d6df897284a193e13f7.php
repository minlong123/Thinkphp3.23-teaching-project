...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://localhost:82/Application/Home/public/css/brand.css">
</head>
<body>
	<!-- 导航内容开始 -->
	<div id="header">
		...
		<div class="brand_column_content">
			...
			<div class="brand_column_content5">
				...
				<div class="brand_column_left brand_column_content7">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_one1.jpg" height="225" width="447"></div>
					<div class="brand_column_content6">品牌1直营</div>
				</div>


				<div class="brand_column_right brand_column_content7">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_one2.jpg" height="225" width="447"></div>
		...
		<div class="brand_column1_content">
			...
			<div class="brand_column1_bottom">
				...
				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand1.jpg"></div>
					<div class="brand_column1_bottom2">促销品牌化策划</div>
				</div>

				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand2.jpg"></div>
					<div class="brand_column1_bottom2">网络微营销策划</div>
				</div>

				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand3.jpg"></div>
					<div class="brand_column1_bottom2">新品上市策划</div>
				</div>

				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand4.jpg"></div>
					<div class="brand_column1_bottom2">终端营销策划</div>
				</div>

				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand5.jpg"></div>
					<div class="brand_column1_bottom2">渠道招商策划</div>
				</div>

				<div class="brand_column1_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand6.jpg"></div>
		...
		<div class="brand_column2_bottom">
			...
			<div class="brand_column2_bottom2">
				...
				<div class="brand_column2_bottom3">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_three1.jpg" width="226" height="280"></div>
					<div class="brand_column2_bottom4">顶层设计</div>
				</div>

				<div class="brand_column2_bottom3">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_three2.jpg" width="226" height="280"></div>
					<div class="brand_column2_bottom4">在哪儿买的呢</div>
				</div>

				<div class="brand_column2_bottom3">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_three3.jpg" width="226" height="280"></div>
					<div class="brand_column2_bottom4">价值链梳理</div>
				</div>

				<div class="brand_column2_bottom3">
					<div><img src="http://localhost:82/Application/Home/public/images/brand_three4.jpg" width="226" height="280"></div>
		...
		<div class="brand_column3_content">
			...
			<div class="brand_column3_bottom">
				...
				<div class="brand_column3_bottom1">
					<div class="brand_column3_bottom2"><img src="http://localhost:82/Application/Home/public/images/aaa.jpg"></div>
				...
				<div class="brand_column3_bottom1">
					<div class="brand_column3_bottom2"><img src="http://localhost:82/Application/Home/public/images/bbb.jpg"></div>
				...
				<div class="brand_column3_bottom1">
					<div class="brand_column3_bottom2"><img src="http://localhost:82/Application/Home/public/images/ccc.jpg"></div>
		...
		<div class="brand_column4_content">
			...
			<div class="brand_column4_bottom">
				...
				<div class="brand_column4_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand-1.jpg" width="89" height="89"></div>
				...
				<div class="brand_column4_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand-2.jpg" width="89" height="89"></div>
				...
				<div class="brand_column4_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand-3.jpg" width="89" height="89"></div>
				...
				<div class="brand_column4_bottom1">
					<div><img src="http://localhost:82/Application/Home/public/images/brand-4.jpg" width="89" height="89"></div>
